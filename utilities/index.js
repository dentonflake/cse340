  ...
  if (data.length > 0) {
    ...
    data.forEach(vehicle => {
      ...
      grid += '<a href="../../inv/detail/' + vehicle.inv_id
        ...
        + 'details"><img class="carImage" src="' + vehicle.inv_thumbnail
...
Util.buildItemDetails = async function (data) {
  ...
  if (data) {
    details += `<div class="container-details">`
    details += `<img class="carDetailsImage" src="${data.inv_thumbnail}" alt="Image of ${data.inv_make} ${data.inv_model} on CSE Motors" />`
    ...
    details += `<p class="notice">Sorry, unable to get item details.</p>`
  }
...
Util.buildClassificationList = async function (classification_id = null) {
  ...
  let classificationList =
    '<select class="inv-form-container__input" name="classification_id" id="classificationList" required>'
